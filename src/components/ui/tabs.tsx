...
function IngestionTab({ dataset, result, datasetLabel, loading, onDatasetChange, onForceReload }: IngestionTabProps & { dataset: DatasetId, loading: boolean, onDatasetChange: (v: DatasetId) => void, onForceReload: () => void }) {
  return (
    <div className="space-y-6 animate-fade-in">
...
/* ==========================================================================
   DOCUMENTATION TAB & OPERATIONS MANUAL USING CUSTOM PRIMITIVES
   ========================================================================== */
...
function DocumentationTab() {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {/* Interactive Tabs Layout for clean, non-cluttered reading context */}
      <Tabs defaultValue="kpis" className="w-full">
        ...
        {/* Tab Sub-Content 2: Ingestion Systems */}
